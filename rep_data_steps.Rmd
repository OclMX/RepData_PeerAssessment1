...
dailyStepsNoNAs <- dfMeanNA %>% select(date, steps) %>% 
...
dailyStepsNoNAs$day <- ifelse(weekdays(dailyStepsNoNAs$date) %in% c("Saturday", "Sunday"), "weekend", "weekday")
dailyStepsNoNAs$day <- factor(dailyStepsNoNAs$day)
